...
# # Using Python to aid your AWS Workflow

# From data storage to computing, Amazon Web Services is a scalable and and cost effective alternative to on premesis options. This guide demonstrates how Urban Institute researchers can use Python in conjunction with Amazon Services S3 and EC2 to create a cloud based workflow. 
...
# EC2 is an amazon service which provides compute capacity in the cloud. Rather than running your models and scripts on Urban on premesis servers, you can run them on EC2 which provides customizable compute capacity, memory, and more. 
# 
...
# 
# To begin, under the *Research Platforms* dropdown on the tech-tools site, select *Start or Stop EC2 instance*. In order to spin up your EC2 instance, you will be able to select whiich instance type you would like based on your specific needs and submit the form. 

# ![title](tech-tools.png)
